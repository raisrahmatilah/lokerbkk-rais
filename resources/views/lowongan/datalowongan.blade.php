...
<body id="page-top">
    <div id="wrapper">
        <ul style="background-color: #2d73db" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <h3 class="text-dark mt-2">Lowongan Kerja BKK</h3>
                    <li style="list-style: none;right: 0;position:absolute;color:#2d73db" class="nav-item active">
